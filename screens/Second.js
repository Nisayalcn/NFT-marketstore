...
import{StyleSheet,Modal,Alert,View,TextInput, Text,Image,Button,TouchableOpacity,FlatList,ScrollView, Pressable} from 'react-native';
...
export default function Second({navigation}) {
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.modalStyle}>
        ...
        <View style={styles.centeredView}>
          <View style={styles.modalView}>
            ...
            <View style={{flexDirection:"row",alignItems:"center",justifyContent:"space-between",width:150,alignContent:"center",height:30}}>
              <TouchableOpacity style={styles.like} onPress={()=>setLike(!like)}>
                <FontAwesomeIcon icon={like===false?(faHeart):(faHeartCircleCheck)}></FontAwesomeIcon>
              </TouchableOpacity>
              <TouchableOpacity style={styles.spam} onPress={()=>setSpam(!spam)}>
                <FontAwesomeIcon icon={spam===false?(faHeartCrack):(faHeartCircleMinus)}></FontAwesomeIcon>
              </TouchableOpacity>
            </View>
      ...
      <View>
        <Text style={{fontWeight:"bold",color:"grey",fontSize:20}}>Top Sallers</Text>
      </View>
